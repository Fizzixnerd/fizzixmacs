...
;;;***

;;;### (autoloads nil "prv-install" "prv-install.el" (0 0 0 0))
;;; Generated autoloads from prv-install.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "prv-install" '("preview-make-package")))

;;;***

;;;### (autoloads nil "prv-xemacs" "prv-xemacs.el" (0 0 0 0))
;;; Generated autoloads from prv-xemacs.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "prv-xemacs" '("preview-")))
...
;;;***

;;;### (autoloads nil nil ("auctex-pkg.el" "auctex.el" "lpath.el"
;;;;;;  "tex-mik.el") (0 0 0 0))
