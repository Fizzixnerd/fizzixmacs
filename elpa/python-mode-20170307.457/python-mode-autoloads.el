...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "python-mode" '("pep8" "pst-here" "pps-emacs-version" "pios" "inf" "ios" "ipy" "iyp" "Python" "IPython" "Ipython" "autopair-mode" "ar--" "variables-" "virtualenv-" "jython-" "durck" "druck" "empty-line-p" "eva" "ffap-alist" "force-py-shell-name-p-o" "flake8" "toggle-" "turn-o" "highlight-indent-active" "hs-hide-comments-when-hiding-all" "smart-operator-mode" "strip-chars-")))
