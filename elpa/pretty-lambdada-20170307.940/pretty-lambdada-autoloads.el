...

;;;### (autoloads nil "pretty-lambdada" "pretty-lambdada.el" (0 0
;;;;;;  0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pretty-lambdada" '("turn-o" "pretty-lambda")))
