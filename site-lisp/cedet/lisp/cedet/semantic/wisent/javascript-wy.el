;;; javascript-wy.el --- Generated parser support file
...
;; generated from the grammar file javascript.wy.
...
;;; Declarations
;;
(defconst wisent-javascript-wy--keyword-table
...
(defconst wisent-javascript-wy--token-table
...
(defconst wisent-javascript-wy--parse-table
  (progn
    (eval-when-compile
...
(defun wisent-javascript-wy--install-parser ()
  "Setup the Semantic Parser."
  (semantic-install-function-overrides
   '((parse-stream . wisent-parse-stream)))
  (setq semantic-parser-name "LALR"
	semantic--parse-table wisent-javascript-wy--parse-table
	semantic-debug-parser-source "javascript.wy"
	semantic-flex-keywords-obarray wisent-javascript-wy--keyword-table
	semantic-lex-types-obarray wisent-javascript-wy--token-table)
...
;;std stuff
  ...
  wisent-javascript-wy--<number>-regexp-analyzer
  wisent-javascript-wy--<string>-sexp-analyzer

  wisent-javascript-wy--<keyword>-keyword-analyzer

  wisent-javascript-wy--<symbol>-regexp-analyzer
  wisent-javascript-wy--<punctuation>-string-analyzer
  wisent-javascript-wy--<block>-block-analyzer
...
(provide 'semantic/wisent/javascript-wy)

;;; javascript-wy.el ends here
